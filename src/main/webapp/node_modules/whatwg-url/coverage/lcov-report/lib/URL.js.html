...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> URL.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
function URL(url) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this || this[impl] || !(this instanceof URL)) {
<span class="cstat-no" title="statement not covered" >    throw new TypeError("Failed to construct 'URL': Please use the 'new' operator, this DOM object constructor cannot be called as a function.");</span>
  }
  <span class="missing-if-branch" title="if path not taken" >I</span>if (arguments.length &lt; 1) {
<span class="cstat-no" title="statement not covered" >    throw new TypeError("Failed to construct 'URL': 1 argument required, but only " + arguments.length + " present.");</span>
  }
  const args = [];
...
URL.prototype.toJSON = function toJSON() {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this || !module.exports.is(this)) {
<span class="cstat-no" title="statement not covered" >    throw new TypeError("Illegal invocation");</span>
  }
  const args = [];
...
Object.defineProperty(URL.prototype, "href", {
  ...
  set<span class="fstat-no" title="function not covered" >(V) {</span>
<span class="cstat-no" title="statement not covered" >    V = conversions["USVString"](V);</span>
<span class="cstat-no" title="statement not covered" >    this[impl].href = V;</span>
  },
  enumerable: true,
  configurable: true
});
...
module.exports = {
  ...
  create<span class="fstat-no" title="function not covered" >(constructorArgs, privateData) {</span>
<span class="cstat-no" title="statement not covered" >    let obj = Object.create(URL.prototype);</span>
<span class="cstat-no" title="statement not covered" >    this.setup(obj, constructorArgs, privateData);</span>
<span class="cstat-no" title="statement not covered" >    return obj;</span>
  },
  setup(obj, constructorArgs, privateData) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!privateData) privateData = {};
