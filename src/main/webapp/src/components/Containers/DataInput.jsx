...
class DataInput extends React.Component {
    ...
    constructor(props) {
        ...
        this.onChangedTrigger=function(e)
        {
            ...
            console.debug("DataInput: onChangedTrigger(value:"+e.target.value+")");
            this.setState({
    ...
    render() {
        console.debug("DataInput: render");
        return (
