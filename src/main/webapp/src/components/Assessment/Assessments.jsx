...
import SetExpiration from "./SetExpiration.jsx";
import Modal from "react-modal";
import AssessmentAPI from "../../libaries/APIs/AssessmentAPI.jsx";
import AdminReview from "./Review/AdminReview.jsx";
...
class Assessment extends React.Component{
    constructor(props) {
        super(props);
        var $this=this;
        this.assessmentChanged=this.assessmentChanged.bind(this);


        this.api=AssessmentAPI.instance.hook().on("add-question-to-assessment",function(data){
            $this.notLoading();
        ...
        $this.myEventHandler.on("questions-loaded",function(e){
            ...
            var assessment=e;
            delete assessment["questionSet"];

            $this.setState({questions:questions,assessment:assessment.assessment});
        });
        ...
        this.stepInstructions= {
            ...
            "mainPage":
                ...
                next:{
                    ...
                    clicked:function($this){
                        $this.MoveTo("reviewAssessments") //sean added this
                    }
                },
                        ...
                        <div className="build-your-assessment-container">
                            ...
                            <div className="top-header-container">
                                ...
                                <div className="top-header-tools">
                                    ...
                                    <AssessmentTimer onSavedTime={$this.assessmentChanged} assessmentID = {$this.getAssessmentID()} timeInSeconds = {$this.state.assessment.allowed_time_sec}
                                                     isTimed = {$this.state.assessment.istimed}/>
                                    </div>
                                    <div onClick={()=>$this.onClickSetExpiration()} className="top-header-expiration-date-container">
            ...
            "reviewAssessments": {
                ...
                next:{
                    ...
                    html:"Finished",
                    clicked:function($this){
                        $this.MoveTo("homePage") //sean added this
                    }
                },
                ...
                render: function () {
                    return (
                        <div>
                            {/* TODO Code will need to change to a local data center before this is usfull. Next Iteration */}
                            {/*<AdminReview assessmentID={assessmentID} questions={$this.state.questions}/>*/}
                            <AdminReview assessment={$this.state} />
                        </div>
                    )
                }
            },
    ...
    loadQuestions(){
        ...
        Rests.Lets().get(
            ...
            function(data)
            {
                ...
                $this.myEventHandler.trigger("questions-loaded",{questions:data.questionSet,assessment:data});
    ...
    onClickSetExpiration(){
        this.setState({
            setExpirationOpen:true
        });
    }
    onClickCloseSetExpiration(){
        this.setState({
            setExpirationOpen:false
        });
    }
    assessmentChanged(data)
    {
        var $this=this;
        this.setState({assessment:data},function(){
    ...
    saveAssessmentData(){
        AssessmentAPI.instance.saveAssessment(this.getAssessmentID(),this.state.assessment);
    }
    getAssessmentID(){
