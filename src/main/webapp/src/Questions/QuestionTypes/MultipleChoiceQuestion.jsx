...
{
    // defaultProps={
    //     onAnswerChanged:function(choices){
    //
    //     },
    //     onDelete:function(choices){
    //
    //     },
    //     editible,
    //     letter:'Unkown',
    ...
    saveEditing(){
        ...
        /*******************************************************************/
        var $this=this;
        this.setState({changingText:false,choice:oldChoice},function(){
            $this.props.onAnswerChanged(this);
        });
    }
...
class AnswerChoices extends React.Component
{
    ...
    deleteAnswer(answerChoice){
        ...
        this.setState({choices:myChoices},function(){
            $this.props.onAnswersChanged(this);
        });
    }
