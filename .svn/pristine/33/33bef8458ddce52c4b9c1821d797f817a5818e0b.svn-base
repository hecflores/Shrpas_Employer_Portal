            ...
            <div>
                ...
                <Modal isOpen={this.state.creatingNewQuestion}>
                    ...
                    <div className="tab-content">
                        <QuestionTypes.MultipleChoiceQuestion id="multipleChoice" isTab="true" isActive="true"/>
                        <QuestionTypes.TextQuestion id="question" isTab="true"/>
                        <QuestionTypes.VideoQuestion id="video" isTab="true"/>
                        <QuestionTypes.CodeQuestion id="code" isTab="true"/>
                    </div>

                    <div>
                        <span className="pull-right">
                            <button type="button" onClick={this.closeCreateQuestions} className="btn btn-primary">Add</button>
